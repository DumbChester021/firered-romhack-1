// Extracted from RHH src/battle_ai_util.c:3754-3774
// 21 lines
// Dependencies: AI_IsFaster, AI_IsSlower, CanTargetFaintAi, DoesSubstituteBlockMove, GetIncomingMoveSpeedCheck, IsMoldBreakerTypeAbility, ShouldTryToFlinch
