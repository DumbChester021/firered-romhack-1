// LevelUpMove learnset encoding — RHH-faithful struct format.
// Replaces old packed u16: (lvl << 9) | move (max move ID 511).
// New format: struct LevelUpMove { u16 move; u16 level; } with no move ID cap.
// Sentinel: entry with .move == LEVEL_UP_END (0xFFFF) terminates the list.
#define LEVEL_UP_MOVE(lvl, move) { (move), (lvl) }
#define LEVEL_UP_END_ENTRY        { LEVEL_UP_END, 0 }  // use this as the terminal entry

// Pokemon Bulbasaur — Gen 9 learnset (RHH-faithful)
...
// Pokemon Ivysaur — Gen 9 learnset (RHH-faithful)
...
// Pokemon Venusaur — Gen 9 learnset (RHH-faithful)
...
// Pokemon Charmander — Gen 9 learnset (RHH-faithful)
...
// Pokemon Charmeleon — Gen 9 learnset (RHH-faithful)
...
// Pokemon Charizard — Gen 9 learnset (RHH-faithful)
...
// Pokemon Squirtle — Gen 9 learnset (RHH-faithful)
...
// Pokemon Wartortle — Gen 9 learnset (RHH-faithful)
...
// Pokemon Blastoise — Gen 9 learnset (RHH-faithful)
