...
#define ANIM_TAG_POKEBLOCK                  ANIM_TAG_SAFARI_BAIT // RHH compat alias
...
#define ANIM_TAG_UNAVAILABLE_1              (ANIM_SPRITES_START + 337)
...
// Used by AnimTask_ShakeMon2, AnimTask_SetGrayscaleOrOriginalPal, and multi-target opcodes
...
// RHH Gen 4+ background IDs (27–81)
